...
set(MSG_I_FLAGS "-Iutils:/home/kurt/Robotics/src/utils/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/utils)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/utils/.+/__init__.pyc?$"
  )
endif()
