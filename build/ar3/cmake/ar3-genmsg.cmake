...
message(STATUS "ar3: 2 messages, 0 services")
...
get_filename_component(_filename "/home/kurt/Robotics/src/ar3/msg/ar3_control.msg" NAME_WE)
add_custom_target(_ar3_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "ar3" "/home/kurt/Robotics/src/ar3/msg/ar3_control.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ar3)
  ...
  install(
    ...
    DESTINATION ${genpy_INSTALL_DIR}
    FILES_MATCHING
    REGEX "${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/ar3/.+/__init__.pyc?$"
  )
endif()
