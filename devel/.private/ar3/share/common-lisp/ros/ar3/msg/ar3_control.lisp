...
(cl:defmethod cl:initialize-instance :after ((m <ar3_control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ar3_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ar3-msg:<ar3_control> is deprecated: use ar3-msg:ar3_control instead.")))

(cl:ensure-generic-function 'home-val :lambda-list '(m))
(cl:defmethod home-val ((m <ar3_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar3-msg:home-val is deprecated.  Use ar3-msg:home instead.")
  (home m))

(cl:ensure-generic-function 'run-val :lambda-list '(m))
(cl:defmethod run-val ((m <ar3_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar3-msg:run-val is deprecated.  Use ar3-msg:run instead.")
  (run m))

(cl:ensure-generic-function 'rest-val :lambda-list '(m))
(cl:defmethod rest-val ((m <ar3_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar3-msg:rest-val is deprecated.  Use ar3-msg:rest instead.")
  (rest m))
...
(cl:defmethod speed-val ((m <ar3_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ar3-msg:speed-val is deprecated.  Use ar3-msg:speed instead.")
  (speed m))
